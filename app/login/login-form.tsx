    ...
    return (
        <form action={formAction} className="space-y-6">
                ...
                <div className="space-y-2">
                    ...
                    <div className="relative">
                        ...
                        <Input
                            ...
                            required
                            className="pl-10 h-12 rounded-lg border-slate-200 dark:border-slate-800 focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all bg-white dark:bg-slate-900"
                        />
                    </div>
                </div>
            ...
            <Button
                type="submit"
                disabled={isPending}
                className="w-full h-12 rounded-lg font-semibold shadow-md hover:shadow-lg transition-all duration-200 disabled:opacity-70 disabled:cursor-not-allowed"
            >
                {isPending ? (
